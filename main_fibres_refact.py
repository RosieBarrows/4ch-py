...
def run_command_with_capture(command, show_output=False):
...
def main(args):
	...
	cmd = f'cp {heartFolder}/{args.msh_path_in}.* {fchPath}'
	run_command_with_capture(cmd, show_output=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--msh-path-in', type=str, default='meshing/myocardium_OUT/myocardium')
