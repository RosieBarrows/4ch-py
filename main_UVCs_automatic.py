...
from main_select_landmarks import select_landmarks
...
def main(args):
	...
	#----------------------------------------------------------------------#
	# Selecting the points needed for the atrial UVCs automatically
	#----------------------------------------------------------------------#

	select_landmarks(heartFolder=heartFolder, input_tags=input_tags)
	# ----------------------------------------------------------------------------------------------
